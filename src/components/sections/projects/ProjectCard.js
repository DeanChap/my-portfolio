...
const ProjectCard = ({ project }) => {
  return (
    <div className="bg-white dark:bg-gray-950 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-4 transition-all duration-300 overflow-hidden">
      <img
